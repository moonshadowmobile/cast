  ...
  return [
    O(
      'Instance',
      {
        'fields': [
          F('name', {'src': 'name'}),
          F('bundle_name', {'src': 'getBundleName'}),
          F('bundle_version', {'src': 'getBundleVersion'}),
          F('service', {'src': 'getSerializedService'})
        ]
      }
    ),
    O(
      'Service',
      {
        'fields': [
          F('name', {'src': 'name'}),
          F('enabled', {'src': 'isEnabledSer', 'coerceTo': 'boolean'}),
          F('status', {'src': 'getStatus'}),
        ]
      }
    )
  ];
