  ...
  return [
    swiz.struct.Obj(
      'Job',
      {
        'fields': [
          F('id', {'src': 'id'}),
          F('jobType', {'src': 'getJogTypeName'}),
          F('jobArgs', {'src': 'args', 'coerceTo': 'array'}),
          F('queued_at', {'src': 'timeQueued'}),
          F('started_at', {'src': 'timeStarted'}),
          F('ended_at', {'src': 'timeStarted'}),
          F('resourceName', {'src': 'resourceName'}),
          F('resourceType', {'src': 'getResourceTypeName'}),
          F('status', {'src': 'status'}),
          F('messages', {'src': 'messages', 'coerceTo': 'array'}),
          F('result', {'src': 'result'})
        ]
      }
    )
