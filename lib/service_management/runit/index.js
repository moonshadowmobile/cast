...
var configDefaults = {
  'service_user': null,
  'svlogd_daemon_user': null,   // @TODO: Change back to utillog when we can retrieve the username
...
util.inherits(RunitService, SupervisedService);
...
util.inherits(RunitServiceManager, SupervisedServiceManager);
